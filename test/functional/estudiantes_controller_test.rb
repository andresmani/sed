...
class EstudiantesControllerTest < ActionController::TestCase
  ...
  test "should create estudiante" do
    assert_difference('Estudiante.count') do
      post :create, estudiante: { apellido: @estudiante.apellido, cel: @estudiante.cel, documento: @estudiante.documento, email: @estudiante.email, fechana: @estudiante.fechana, nombre: @estudiante.nombre, tel: @estudiante.tel }
    end
  ...
  test "should update estudiante" do
    put :update, id: @estudiante, estudiante: { apellido: @estudiante.apellido, cel: @estudiante.cel, documento: @estudiante.documento, email: @estudiante.email, fechana: @estudiante.fechana, nombre: @estudiante.nombre, tel: @estudiante.tel }
    assert_redirected_to estudiante_path(assigns(:estudiante))
  end
